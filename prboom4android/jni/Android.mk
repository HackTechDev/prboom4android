...
#includes
INC 		:= -I$(PRBOOM) -I$(PRBOOM)/include

PRBOOM_FLAGS 	:= -DNORMALUNIX -DLINUX -DHAVE_CONFIG_H
...
LOCAL_SRC_FILES := \
	...
	d_client.c d_server.c i_video.c i_network.c i_system.c \
